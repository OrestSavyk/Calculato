...
export class CalculatorComponent implements OnInit {
  ...
  private actionEvent(button: any) {
    switch (button.value) {
      case '+':
        this.funcParent('+');
  ...
  onButton(button: any) {
    switch (button.type) {
      case 'digit':
        this.digitEvent(button);

        break;

      case 'action':
        this.actionEvent(button);

        break;

      case 'other':
        this.otherEvent(button);
